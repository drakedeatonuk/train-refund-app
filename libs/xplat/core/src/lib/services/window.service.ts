// angular
import { Injectable, Inject, ViewContainerRef } from '../forks/angular-datetime-picker/node_modules/@angular/core/core';

// app
import { isObject, isNativeScript } from '@multi/xplat/utils';
...
export class WindowService {
  ...
  public confirm(msg: any, action?: Function /* used for fancyalerts on mobile*/): Promise<boolean> {
    return new Promise((resolve, reject) => {
